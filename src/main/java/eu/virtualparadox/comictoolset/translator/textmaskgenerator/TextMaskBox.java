 ...
 */
public final class TextMaskBox {
    public final int x1;
    public final int y1;
    public final int x2;
    public final int y2;
     ...
     */
    public TextMaskBox(int x1, int y1, int x2, int y2, float confidence) {
        this.x1 = x1;
        this.y1 = y1;
        this.x2 = x2;
        this.y2 = y2;
    ...
    private TextMaskBox(int x1, int y1, int x2, int y2, int originalX1, int originalY1, int originalX2, int originalY2, float confidence) {
        this.x1 = x1;
        this.y1 = y1;
        this.x2 = x2;
        this.y2 = y2;
    ...
    public TextMaskBox enlarge(int paddingX, int paddingY) {
        return new TextMaskBox(x1 - paddingX, y1 - paddingY, x2 + paddingX, y2 + paddingY, x1, y1, x2, y2, confidence);
    }

    @Override
    public boolean equals(Object o) {
        if (o == null || getClass() != o.getClass()) return false;
        TextMaskBox that = (TextMaskBox) o;
